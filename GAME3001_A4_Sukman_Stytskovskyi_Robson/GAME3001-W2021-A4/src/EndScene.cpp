...
void EndScene::start()
{
	...
	m_label = new Label("You Win!", "JosefinSans", 40, blue, glm::vec2(400.0f, 120.0f));
	m_label->setParent(this);
	addChild(m_label);

	// Restart Button
	m_pRestartButton = new Button("../Assets/textures/MainMenu.png", "mainmenubutton", RESTART_BUTTON);
